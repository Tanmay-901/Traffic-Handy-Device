...
int readsuccess, penalty;
byte readcard[4];
char str[32] = "";
String StrUID, charge;
...
void loop() {
  ...
  if(readsuccess) {
   ...
   Serial.println("");
    ...
    Serial.print(int(penalty));
    Serial.print(" for lack of ");
    Serial.print(charge);
    Serial.print(" !!!");
    Serial.println("");
    Serial.println("");
    ...
    Serial.println("Mr. Tanmay is fined Rs. ");
    Serial.print(int(penalty));
    Serial.print(" for lack of ");
    Serial.print(charge);
    Serial.print(" !!!");
  ...
  if(StrUID=="FE9EC983"){
    ...
    Serial.println("Miss. Shivani is fined Rs. ");
    Serial.print(int(penalty));
    Serial.print(" for lack of ");
    Serial.print(charge);
    Serial.print(" !!!");
